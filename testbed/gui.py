...
class Worker(QtCore.QThread):
    ...
    def setup(self, window_size=20, n=2, w=28, h=28, d=1, hidden_layers_sizes=[100], pretrain_step=20):
...
class Window(QtGui.QDialog):
    def __init__(self, parent=None):
        ...
        self.w_line_edit = QtGui.QLineEdit('28')
        self.w_line_edit.textChanged.connect(self.dnnChanged)
        self.h_line_edit = QtGui.QLineEdit('28')
        ...
        self.hidden_layer_sizes_line_edit = QtGui.QLineEdit('100')
